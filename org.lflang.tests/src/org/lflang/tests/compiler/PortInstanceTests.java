...
public class PortInstanceTests {
    ...
    public void createRange() throws Exception {
        ...
        Assertions.assertEquals(
                "[.A.p(0,1)->[.E.F.t(0,1), .E.s(0,1), .B.q(2,1)], .A.p(1,2)->[.E.G.u(0,2), .E.s(1,2), .C.r(0,2)]]",
                sr.toString());
    }
     ...
     * @param dst The receiving port.
     */
    protected void connect(PortInstance src, int srcStart, int srcWidth, PortInstance dst, int dstStart, int dstWidth) {
