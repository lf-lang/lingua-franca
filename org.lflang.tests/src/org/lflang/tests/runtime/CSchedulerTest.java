...
public class CSchedulerTest extends TestBase {
     ...
     * tests. Only run tests for a specific non-default scheduler if specified using a system
     * property (e.g., -Dscheduler=GEDF_NP).
     */
    @Test
    public void runWithNonDefaultSchedulers() {
        EnumSet<TestCategory> categories =
                EnumSet.of(TestCategory.CONCURRENT, TestCategory.MULTIPORT);
