...
public class LFLanguageServer extends KGraphLanguageServerExtension {
  ...
  protected Hover hover(HoverParams params, CancelIndicator cancelIndicator) {
    // This override is just a hacky little patch that is being applied downstream of the original
    // mistake and
    //  upstream of the ungraceful handling (IndexOutOfBoundsException) of said mistake. This patch
    // is applied here
    //  simply because it is easy. This would be done differently were it not for the fact that we
    // plan to rebuild
