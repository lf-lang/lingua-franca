...
sequenceNames = {
    ...
    'lf4': 'LF C++ (4 threads)',
    'lf8': 'LF C++ (8 threads)',
    'lf16': 'LF C++ (16 threads)',
    'savina-akka-default': 'Savina Akka default config',
...
runCmdAkka = f'java -classpath {savinaJarPath} {savinaPackagePathBase}.chameneos.ChameneosAkkaActorBenchmark -iter {numIterationsAkka} -numChameneos {constParam1} -numMeetings'
...
experiments['ProdConsVarNumItemsPerProducer'] = {
    ...
    'plotAdditionalGnuplotHeaderCommands': '',
    'sequenceParameterForGlobalPlot': '1',
    'globalPlotXAxisLabel': f'Producer-consumer ({paramValue3} producers and {paramValue4} consumers)',
