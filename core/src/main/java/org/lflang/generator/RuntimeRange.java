...
/**
 * A representation of a range of runtime instance objects (port channels, reactors, reactions,
...
public class RuntimeRange<T extends NamedInstance<?>> implements Comparable<RuntimeRange<?>> {
   ...
   *       never a bank).
   * * Each index that is returned can be used as an index into an array of runtime instances
