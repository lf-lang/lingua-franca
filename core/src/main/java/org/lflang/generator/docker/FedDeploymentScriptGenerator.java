...
public class FedDeploymentScriptGenerator {
    ...
    public void generate() throws IOException {
        ...
        var scriptContent = generateDeploymentLaunchScript(srcGenPath.toString(), deploymentType, federationName);
    ...
    private String generateDeploymentLaunchScript(String srcGenPath, String deploymentType, String federationName) {
        ...
        var logStreaming = """
                ...
                wait
                """.formatted(federationName.toLowerCase(), federationName.toLowerCase(), federationName.toLowerCase());

        var deploySteps = deploymentType.equals("kubernetes")
                ? kubectlCheck
                    + podFileCheck
                    + """
