                ...
                if (isEnclave(inst)) {
                    ...
                    for (Instantiation downstream: downStreamMap.keySet()) {
                        if (downstream.equals(ast.PARENT)) {
                            ...
                            ReactorInstance down = current.children.stream().filter(i -> i.getDefinition() == downstream).findFirst().get();
                    ...
                    for (Instantiation upstream: upstreamMap.keySet()) {
                        if (upstream.equals(ast.PARENT)) {
                            ...
                            ReactorInstance up = current.children.stream().filter(i -> i.getDefinition() == upstream).findFirst().get();
