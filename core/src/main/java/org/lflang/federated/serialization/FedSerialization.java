...
public interface FedSerialization {
   ...
   * 'varName' from its 'originalType' into an unsigned byte array. The serialized data will be put
   * in a variable with the name defined by @see serializedVarName.
   *
  ...
  /**
   * @return Code in target language that includes all the necessary preamble to enable support for
