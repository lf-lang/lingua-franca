...
public class DagNode {
  ...
  /** 
   * Get instructions generated by this node for a specific worker's instructions.
   * It is important to note that nodes do NOT memorize instructions internally,
   * because the instructions and their order change in the schedule during
   * optimization passes. So source of truth should come from the workerInstructions list.
   * Each instruction memorizes the node it belongs to. When we want to query a
   * list of instructions owned by a node, a _view_ of workerInstructions is generated
   * to collect instructions which belong to that node.
   */
