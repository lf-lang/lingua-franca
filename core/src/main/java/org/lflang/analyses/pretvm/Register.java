...
public class Register {
    ...
    public static final Register START_TIME = new Register(GlobalVarType.EXTERN_START_TIME, null, null);
    public static final Register OFFSET = new Register(GlobalVarType.GLOBAL_OFFSET, null, null);
    public static final Register OFFSET_INC = new Register(GlobalVarType.GLOBAL_OFFSET_INC, null, null);
    ...
    public static final Register ABSTRACT_WORKER_RETURN_ADDR = new Register(GlobalVarType.WORKER_RETURN_ADDR, null, null);
