 ...
 *
 * This class helps to separate the rules of type inference from code generation for types. It is
 ...
 *
 * ASTUtils provides functionality to create an inferred type from Lingua Franca variables
