...
public abstract class MalleableString {
    ...
    public abstract RenderResult render(
            int indentation, String singleLineCommentMarker, boolean codeMapTag, EObject enclosingEObject);
    ...
    public static final class Joiner implements Collector<MalleableString, Builder, MalleableString> {
        ...
        public Joiner(MalleableString separator, MalleableString prefix, MalleableString suffix) {
            this.appendSeparator = builder -> builder.components.isEmpty() ? builder : builder.append(separator);
        ...
        public Joiner(String separator, String prefix, String suffix) {
            this(MalleableString.anyOf(separator), MalleableString.anyOf(prefix), MalleableString.anyOf(suffix));
        }
    ...
    public record RenderResult(Stream<String> unplacedComments, String rendering, int levelsOfCommentDisplacement) {
        private RenderResult with(Stream<String> moreUnplacedComments) {
            return new RenderResult(
                    Stream.concat(moreUnplacedComments, unplacedComments), rendering, levelsOfCommentDisplacement);
        }
    }
    ...
    private static final class Sequence extends MalleableString {
        ...
        public RenderResult render(
                int indentation, String singleLineCommentPrefix, boolean codeMapTag, EObject enclosingEObject) {
            ...
            return new RenderResult(
                    ...
                    componentRenderings.stream()
                                    .mapToInt(RenderResult::levelsOfCommentDisplacement)
                                    .sum()
         ...
         *     representation.
         */
        private int inlineCommentStartColumn(List<String> stringComponents, List<List<String>> comments) {
        ...
        private List<String> getLinesOfInterest(List<String> stringComponents, List<List<String>> comments) {
        ...
        public void findBestRepresentation(
            ...
            if (components.stream().noneMatch(it -> it.render(indentation, singleLineCommentPrefix, false, null)
                    .unplacedComments
                    .findAny()
                    .isPresent())) return;
        ...
        private void optimizeChildren(
            ...
            components
                    .reverse()
                    .forEach(it -> it.findBestRepresentation(
    ...
    private static final class Indented extends MalleableString {
        ...
        public RenderResult render(
            ...
            return new RenderResult(
                    ...
                    (renderedComments.isBlank() ? result.rendering : renderedComments + "\n" + result.rendering)
    ...
    private abstract static class MalleableStringWithAlternatives<T> extends MalleableString {
        ...
        public void findBestRepresentation(
            ...
            if (bestPossibility instanceof MalleableString ms) {
                ms.findBestRepresentation(providedRender, badness, width, indentation, singleLineCommentPrefix);
            }
        }
        ...
        protected T getChosenPossibility() {
            if (getPossibilities().isEmpty()) {
                throw new IllegalStateException(
                        "A MalleableString must be directly or transitively backed " + "by at least one String.");
            }
