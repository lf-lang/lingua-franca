...
public abstract class MalleableString {
    ...
    public static final class Builder {
        ...
        public Builder prepend(MalleableString... possibilities) {
            return insert(
                    Function.identity(), Fork::new, possibilities, ms -> components.add(0, ms));
        }
    ...
    public static final class Joiner
            implements Collector<MalleableString, Builder, MalleableString> {
        ...
        /**
         * Join strings using {@code separator} and delimit the result with {@code prefix} and
         * {@code suffix}.
         */
        ...
        public RenderResult render(
            ...
            List<RenderResult> componentRenderings =
                    components.stream()
                            .map(
                                    malleableString ->
                                            // The code map tags *should* not affect the correctness
                                            // of the formatting
                                            // since most
                                            // formatting has already happened in
            ...
            return new RenderResult(
                    Stream.concat(
                            this.comments.stream(), commentsThatCouldNotBeHandledHere.stream()),
        ...
        public RenderResult render(
            ...
            return new RenderResult(
                    ...
                    enclosingEObject instanceof Code && codeMapTag
                            ? CodeMap.Correspondence.tag(
                                    enclosingEObject, getChosenPossibility(), true)
