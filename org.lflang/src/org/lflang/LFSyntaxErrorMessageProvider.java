    ...
    public SyntaxErrorMessage getSyntaxErrorMessage(IParserErrorContext context) {
        ...
        if (context != null) {
            ...
            if (message.contains("expecting '''")) {
                return new SyntaxErrorMessage("Single quotes can only be used around single characters, not strings. "
                        + "Please use double quotes instead.", SINGLY_QUOTED_STRING);
            }
                ...
                if (token != null) {
                    ...
                    if (text != null) {
                        ...
                        if (keywords == null) {
                            ...
                            this.keywords = GrammarUtil
                                    .getAllKeywords(grammarAccess.getGrammar())
                                    .stream()
                                    .filter(k -> k
                                            .matches("^([a-z]|[A-Z]|_)+(\\w|_)*$"))
