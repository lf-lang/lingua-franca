...
public interface FedSerialization {
    ...
    /**
     * @return Expression in target language that corresponds to the length of the serialized
     *     buffer.
     */
    ...
    /**
     * Generate code in target language that serializes 'varName'. This code will convert the data
     * in 'varName' from its 'originalType' into an unsigned byte array. The serialized data will be
     * put in a variable with the name defined by @see serializedVarName.
     *
     ...
     * in 'varName' from an unsigned byte array into the 'targetType'. The deserialized data will be
     * put in a variable with the name defined by
     *
    ...
    /**
     * @return Code in target language that includes all the necessary preamble to enable support
     *     for the current serializer.
     */
