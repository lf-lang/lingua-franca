...
public class LanguageDiagramServer extends AbstractLanguageServer {
    ...
    private static class LFLsCreator extends AbstractLsCreator {
        ...
        public Module createLSModules(boolean socket) {
            return Modules2.mixin(
                    Modules.override(super.createLSModules(socket))
                            .with(
                                    new AbstractGenericModule() {
                                        public Class<? extends LanguageServerImpl>
                                                bindLanguageServerImpl() {
                                            return LFLanguageServer.class;
                                        }
                                    }),
                    it -> {
                        // Temporary fix for an issue of Klighd with Xtext 2.28
                        // (https://github.com/kieler/KLighD/issues/144)
                        it.bind(IGrammarAccess.class).to(KGraphGrammarAccess.class);
                        it.bind(String.class)
                                .annotatedWith(Names.named(Constants.LANGUAGE_NAME))
                                .toInstance("de.cau.cs.kieler.kgraph.text.KGraph");
                    });
        }
        ...
        public List<ILanguageServerExtension> getLanguageServerExtensions() {
            ...
            return List.of(
                    injector.getInstance(LFRegistrationLanguageServerExtension.class),
                    constraints,
                    rectPack,
                    lfExtension);
        }
        ...
        public void onConnect() {
            ...
            // The following is needed because VS Code treats System.err like System.out and
            // System.out like a shout
            // into the void.
    ...
    private static class LFRegistrationLanguageServerExtension
            extends AbstractRegistrationLanguageServerExtension {
