...
class LFLanguageServerExtension implements ILanguageServerExtension {
    ...
    /**
     * Completely build the specified LF program and provide information that is sufficient to run
     * it.
     *
    ...
    private GeneratorResult buildWithProgress(
        ...
        try {
            ...
            // This error will appear as a silent failure to most users, but that is acceptable
            // because this error
