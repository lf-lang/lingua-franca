...
public class SynthesisRegistration implements IKlighdStartupHook {
    ...
    public void execute() {
        ...
        // Blacklist LF-specific properties that should be removed when a diagram is sent from the diagram server to a
        // client.
        ...
        reg.registerBlacklistedProperty(
                NamedInstanceUtil.LINKED_INSTANCE); // Very important since its values can not be synthesized easily!
    }
}
