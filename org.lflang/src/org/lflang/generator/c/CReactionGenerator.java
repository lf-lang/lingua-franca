...
public class CReactionGenerator {
     ...
     */
    public static String generateInitializationForReaction(String body, Reaction reaction, ReactorDecl decl, int reactionIndex, CTypes types, ErrorReporter errorReporter) {
        ...
        if (reaction.getStp() == null) {
            ...
            // handler.
            code.pr(generateIntendedTagInheritence(body, reaction, decl, reactionIndex));
        }
    }
     ...
     * @param reactionIndex The index of the reaction relative to other reactions in the reactor, starting from 0
     */
    private static String generateIntendedTagInheritence(String body, Reaction reaction, ReactorDecl decl, int reactionIndex) {
