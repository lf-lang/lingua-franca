...
public class CParameterGenerator {
     ...
     * parameter initializer refers to other parameters, then those parameter references are
     * replaced with accesses to the self struct of the parents of those parameters.
     */
