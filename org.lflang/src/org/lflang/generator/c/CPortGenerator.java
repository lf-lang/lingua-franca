...
public class CPortGenerator {
    ...
    /**
     * For the specified port, return a declaration for port struct to contain the value of the
     * port. A multiport output with width 4 and type int[10], for example, will result in this: ```
     * int value[10]; ``` There will be an array of size 4 of structs, each containing this value
     * array.
     *
     * @param port The port.
            ...
            if (ASTUtils.isMultiport(input)) {
                body.pr(
                        ...
                        String.join(
                                ...
                                variableStructType(input, reactor, false)
                                        + "** _lf_"
                                        + inputName
                                        + ";",
            ...
            if (ASTUtils.isMultiport(output)) {
                body.pr(
                        ...
                        String.join(
                                ...
                                "// So we have to handle multiports specially here a construct"
                                        + " that",
                                "// array of pointers.",
                                variableStructType(output, reactor, false)
                                        + "** _lf_"
