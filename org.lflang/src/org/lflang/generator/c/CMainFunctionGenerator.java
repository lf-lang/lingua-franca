...
public class CMainFunctionGenerator {
     ...
     *
     * <p>Ideally, this code would belong to its own `main.c` file, but it currently lives in the
     * same file as all the code generated for reactors.
     */
    ...
    private String generateMainFunction() {
        if (targetConfig.platformOptions.platform == Platform.ARDUINO) {
            /**
             * By default, we must have a serial begin line prior to calling lf_reactor_c_main due
             * to internal debugging messages requiring a print buffer. For the future, we can check
                        ...
                        "const char* _lf_default_argv[] = { "
                                + StringUtil.addDoubleQuotes(
                                        StringUtil.joinObjects(
                                                runCommand, StringUtil.addDoubleQuotes(", ")))
                                + " };",
