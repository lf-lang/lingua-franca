...
public class PythonReactorGenerator {
    ...
    public static String generatePythonClass(
            ReactorInstance instance, List<String> instantiatedClasses, ReactorInstance main, PythonTypes types) {
     ...
     */
    public static String generatePythonClassInstantiations(ReactorInstance instance, ReactorInstance main) {
        CodeBuilder code = new CodeBuilder();
     ...
     */
    private static String generatePythonClassInstantiation(ReactorInstance instance, String className) {
        CodeBuilder code = new CodeBuilder();
