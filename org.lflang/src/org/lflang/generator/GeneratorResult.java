...
public class GeneratorResult {
    ...
    public enum Status {
        ...
        FAILED(result -> ""), // This may be due to a failed validation check, in which case the
    ...
    /**
     * Return the result of an incomplete generation task that terminated with status {@code
     * status}.
     *
     * @return the result of an incomplete generation task that terminated with status {@code
     *     status}
    ...
    /**
     * Return a map from generated sources to their code maps. The completeness of this resulting
     * map is given on a best-effort basis, but those mappings that it does contain are guaranteed
     * to be correct.
     *
