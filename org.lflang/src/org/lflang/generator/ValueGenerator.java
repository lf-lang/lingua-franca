...
public final class ValueGenerator {
    ...
    public String getTargetTime(Time t) {
        return timeInTargetLanguage.apply(new TimeValue(t.getInterval(), t.getUnit()));
    }
    ...
    public String getTargetValue(Value v, boolean isTime) {
        ...
        if (isTime && ASTUtils.isZero(v)) return timeInTargetLanguage.apply(new TimeValue(0, TimeUnit.NONE));
