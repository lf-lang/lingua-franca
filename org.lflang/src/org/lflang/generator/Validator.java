...
public abstract class Validator {
     ...
     */
    // This will cause silent validation failures if it takes too long to write all generated code
    // to the file system.
    ...
    /**
     * Return the validation strategies and validation commands corresponding to each generated
     * file.
     *
     * @return the validation strategies and validation commands corresponding to each generated
     *     file
     ...
     *
     * @return the validation strategy and command corresponding to the given file if such a
     *     strategy and command are available
     */
    ...
    /**
     * List all validation strategies that exist for the implementor without filtering by platform
     * or availability.
     */
