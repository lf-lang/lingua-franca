...
\lstdefinelanguage{LF}{
  ...
  %more
  keywords={reaction, preamble, target, actor, composite, trigger, input, output, constructor},
...
These models are more restrictive than our propsed work and lack the polyglot flexibility of our approach.
