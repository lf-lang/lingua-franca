...
These properties make actors an ideal for programming\marten{This sentence was cut off see (0afb2f1aa097d0b51f88831625d42478044f39bf)}The lack of any guarantees with respect to the ordering of messages, and the absence of a notion of time, makes this a very general model, albeit a less useful one for the specification of systems in which timely execution and determinism are important.
