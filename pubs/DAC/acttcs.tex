...
It declares an output named \texttt{out} of type \texttt{int}, a
\keyword{clock} which will trigger reactions periodically, and an input named {\tt set} of type {\tt int}.
...
\begin{enumerate}
	...
	a value on a \emph{logical} time line.
