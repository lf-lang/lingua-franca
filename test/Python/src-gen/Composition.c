...
test_self_t* new_Test() {
    ...
    //**********************************************
    generic_port_instance_struct* tmp_x;
    tmp_x = PyObject_New(generic_port_instance_struct, &port_instance_t);
    tmp_x = PyObject_Init(tmp_x,  &port_instance_t);
    tmp_x->value = PyLong_FromLong(0);
    self->__x = &tmp_x;

    self->count = PyLong_FromLong(0);
    //**********************************************
...
source_self_t* new_Source() {
    ...
    //**********************************************
    self->__y = PyObject_New(generic_port_instance_struct, &port_instance_t);
    self->__y = PyObject_Init(self->__y,  &port_instance_t);
    self->__y->value = PyLong_FromLong(0);
