...
// C:\Users\soyer\lingua-franca-master\git\lingua-franca\benchmark\C\Savina\PingPong.lf
// =============== START reactor class Pong
#line 45 "file:C:\\Users\\soyer\\lingua-franca-master\\git\\lingua-franca\\benchmark\\C\\Savina\\PingPong.lf"
typedef struct {
typedef struct {
    int bank_index;
    int expected;
...
#line 29 "file:C:\\Users\\soyer\\lingua-franca-master\\git\\lingua-franca\\benchmark\\C\\Savina\\PingPong.lf"
typedef struct {
typedef struct {
    int bank_index;
    int count;
