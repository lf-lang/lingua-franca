...
*** «parseErrors.join("\n*** ")»''')
    	...
    	for (generatedFile: allFiles.keySet) {
   		...
   		println("Compiling generated file: " + cFile)
   		// FIXME: Augment the Target keyword to allow compile and run commands to be specified.
   		// FIXME: Redirect output executable to suitable filename.
		var builder = new ProcessBuilder("cc", "pqueue.c", "reactor.c", cFile);
		...
		if (stderr.length() > 0) {
			...
			// Run the generated code.
   			println("Running the generated file: " + cFile)
   			// FIXME: Augment the Target keyword to allow compile and run commands to be specified.
			builder = new ProcessBuilder("./a.out", "-fast", "-stop", "10", "secs")
			builder.directory(directory.toFile)
