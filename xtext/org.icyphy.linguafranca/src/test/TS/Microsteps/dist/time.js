...
exports.getCurrentPhysicalTime = getCurrentPhysicalTime;
exports.Origin = exports.Tag = exports.UnitBasedTimeValue = exports.TimeValue = exports.TimeUnit = void 0;
...
(function (TimeUnit) {
  TimeUnit[TimeUnit["nsec"] = 1] = "nsec";
  TimeUnit[TimeUnit["usec"] = 1000] = "usec";
  TimeUnit[TimeUnit["msec"] = 1000000] = "msec";
  TimeUnit[TimeUnit["sec"] = 1000000000] = "sec";
  TimeUnit[TimeUnit["secs"] = 1000000000] = "secs";
  TimeUnit[TimeUnit["minute"] = 60000000000] = "minute";
  TimeUnit[TimeUnit["minutes"] = 60000000000] = "minutes";
  TimeUnit[TimeUnit["hour"] = 3600000000000] = "hour";
  TimeUnit[TimeUnit["hours"] = 3600000000000] = "hours";
  TimeUnit[TimeUnit["day"] = 86400000000000] = "day";
  TimeUnit[TimeUnit["days"] = 86400000000000] = "days";
  TimeUnit[TimeUnit["week"] = 604800000000000] = "week";
  TimeUnit[TimeUnit["weeks"] = 604800000000000] = "weeks";
...
class UnitBasedTimeValue extends TimeValue {
  /**
  ...
  constructor(value, unit) {
    ...
    const billion = BigInt(TimeUnit.secs); // To avoid overflow and floating point errors, work with BigInts.
...
exports.UnitBasedTimeValue = UnitBasedTimeValue;
...
class Tag {
   ...
   */
  constructor(timeSinceEpoch, microstep = 0) {
  ...
  isEarlierThan(other) {
    return this.time.isSmallerThan(other.time) || this.time.isEqualTo(other.time) && this.microstep < other.microstep;
  }
  /**
...
(function (Origin) {
  Origin[Origin["physical"] = 0] = "physical";
  Origin[Origin["logical"] = 1] = "logical";
})(Origin || (exports.Origin = Origin = {}));

function getCurrentPhysicalTime() {
  let t = Microtime.now();
  let seconds = Math.floor(t / 1000000);
  let nseconds = t * 1000 - seconds * 1000000000;
