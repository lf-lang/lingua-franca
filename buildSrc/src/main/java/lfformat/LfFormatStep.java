...
public final class LfFormatStep {
    ...
    public static class Step implements FormatterStep, Serializable {
        ...
        public String format(
                @SuppressWarnings("NullableProblems") String rawUnix, @SuppressWarnings("NullableProblems") File file)
        ...
        private Process runFormatter(File file) throws IOException {
            ...
            final ResourceBundle properties =
                    ResourceBundle.getBundle("StringsBundle", Locale.getDefault(), new URLClassLoader(new URL[] {
                        resourcePath.toUri().toURL()
                    }));
            final Path lffPath = Path.of(
                    "org.lflang", "build", "libs", String.format("org.lflang-%s.jar", properties.getString("VERSION")));
