...
This release includes new features such as support for the FlexPRET platform, and multi-threading on the RP2040 platform. Enhancements include broader and more customizable support for Docker, and fixes for various bugs related to C++ ports, nRF52, and Dockerfile generation. Additionally, new tests were added, dependencies were updated, and several bug fixes and enhancements were made across various runtime implementations.
